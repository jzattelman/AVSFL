...
class PilotsControllerTest < ActionController::TestCase
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post :create, pilot: { arn: @pilot.arn, first_name: @pilot.first_name, last_name: @pilot.last_name, uav_certified: @pilot.uav_certified }
    end
  ...
  test "should update pilot" do
    put :update, id: @pilot, pilot: { arn: @pilot.arn, first_name: @pilot.first_name, last_name: @pilot.last_name, uav_certified: @pilot.uav_certified }
    assert_redirected_to pilot_path(assigns(:pilot))
  end
